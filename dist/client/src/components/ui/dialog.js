...
function Dialog({ ...props }) {
    ...
    return (_jsx(DialogCompositionContext.Provider, { value: contextValue, children: _jsx(DialogPrimitive.Root, { "data-slot": "dialog", ...props }) }));
}
